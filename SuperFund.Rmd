...
The EPA has been identifying and managing the cleanup of [Superfund](https://www.epa.gov/superfund) (highly contaminated sites) for 40 years. Prior to the EPA there was no regulatory body that could control polution.

Highly toxic locations where manufacturing by-products have been carelessly introduced into the environment due to inadequate regulations, greed, or disregard for the generational damages to flora, fauna, ourselves and the earths viability to support life. It sickens me to think that we have poisoned the natural world to enrich a small portion of the population. I think of the suffering of all life and the wasteland humanity seems to have embraced in the name of progress since the dark ages.

There are many datasets available on the EPA website, I've chosen to review the active list of National Properties or NPL. [Superfund Data and Reports](https://www.epa.gov/superfund/superfund-data-and-reports)
...
I'm interested in putting together a shiny leaflet application based on the unique sites and the more prevalant contaminants.
...
colnames(state_contaminants) <- c("contaminant_name", "n.contaminants_state", "state_name",
                                  "state_abr", "longitude", "latitude", "site_name", "media",                                          "n.log_counts", "log_odds_weighted", "fiscal_year", "colour")

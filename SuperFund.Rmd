...
state_contaminants <- state_contaminants_temp %>% 
  ...
  mutate(media = case_when(
    ...
    TRUE ~ media)) %>% 
  mutate(pubclink = paste0("<b><a href = 'https://pubchem.ncbi.nlm.nih.gov/#query=", contaminant_name,"'>"),
         sitelink = paste0("<b><a href = 'https://search.epa.gov/epasearch/?querytext=", site_name,
                           "&areaname=&areacontacts=&areasearchurl=&typeofsearch=epa&result_template=2col.ftl#/'>"))

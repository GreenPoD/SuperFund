...
# write the csv file
write_csv(unique_contaminants, "C:/Users/jerem/Documents/R Projects/SuperFund/table_contaminants.csv")
...
unique_sites <- unique_sites %>% 
  separate(col = "site_id", into = c("longitude", "latitude"),sep = ",") %>% 
  mutate(longitude = as.numeric(longitude), latitude = as.numeric(latitude)) %>% 
  filter(!is.na(longitude), !is.na(latitude))

# write the csv file
write_csv(unique_sites, "C:/Users/jerem/Documents/R Projects/SuperFund/unique_site_id.csv")
...
# OCD column renaming 
colnames(unique_sites) <- c("lng", "lat")
